...
var LevelsInfo:={
	1:["Первая встреча",[ ["Monolog",11],["Monolog",12],["Connector",0],["Monolog",13],["Connector",1],["Connector",2],["Connector",3],["Connector",4],["Connector",5],["Connector",6],["Connector",7],["Connector",8],["Connector",9],["Connector",10],["Connector",11] ]],
	2:[],
	3:[],
	4:[],
	5:[],
...
var SegmentsInfo:={
	...
	"Connector":{ #Images name + Text
		...
		0:["ВРАЧ","НОС","ФЛАГ","ДОМ","ЧАЙ","ЛУК","ГРИБ","ТОРТ","ДВЕРЬ","МЫШЬ"],
		1:["СТУЛ","РЫСЬ","МЯЧ","КОТ","ЛОСЬ","СОМ","СУП","КРАН","ФЕН","ШАР"],
		2:["РЫБА","СОК","ВОЛК","КАША","ЛИСТ","БЫК","ЦВЕТОК","КРОТ","СТОЛ","СЫР"],
